export const dict = {
  ...
  "command.session.goLive": "Go Live",
  ...
  "session.live.label": "Live",
  "session.live.buffered": "{{count}} buffered",
  "session.live.digest.seconds": "Last digest {{count}}s ago",
  "session.live.digest.minutes": "Last digest {{count}}m ago",
  ...
  "session.live.setup.copy": "Copy",
  "session.live.setup.copied": "Copied",
  "session.live.setup.checklist": "Status",
  "session.live.setup.status.connected": "Connected — capturing browser activity",
  "session.live.setup.status.connectedHint": "Your browser is streaming telemetry to this session.",
  "session.live.setup.status.waiting": "Connected — waiting for activity",
  "session.live.setup.status.waitingHint": "Navigate or click in your app to start capturing events.",
  "session.live.setup.status.disconnected": "Not connected yet",
  "session.live.setup.status.disconnectedHint": "Follow one of the methods below to connect your browser.",
  "session.live.setup.check.session": "Live session active",
  "session.live.setup.check.sessionOff": "Live session not bound",
  "session.live.setup.check.connected": "Browser is streaming telemetry",
  "session.live.setup.check.connectedOff": "No browser connected",
  "session.live.setup.check.eventsCount": "{{count}} events captured",
  "session.live.setup.check.eventsOff": "No events captured yet",
  "session.live.setup.method.inject.title": "Option A · Inject the capture script",
  "session.live.setup.method.inject.subtitle": "Works in any browser.",
  "session.live.setup.method.inject.step1": "Add this tag to your app's HTML <head>:",
  "session.live.setup.method.inject.step2": "Reload your app in the browser.",
  "session.live.setup.method.inject.step3": "The status above turns green once it connects.",
  "session.live.setup.method.inject.note":
    "The script is only served while this live session is active and carries a one-time capture ticket.",
  "session.live.setup.method.cdp.title": "Option B · Chrome DevTools Protocol",
  "session.live.setup.method.cdp.subtitle": "No code changes. Chromium-based browsers only.",
  "session.live.setup.method.cdp.step1":
